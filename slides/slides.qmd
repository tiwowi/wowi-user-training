...
### Input files
::::{.columns}
:::{.column width="33%" text-align="left"}
![Case file](cases.png)
:::
:::{.column  width="33%"}
![Control file](control.png)
:::
:::{.column  width="33%"}
![Geo Coordinates file](geo-file.png)
:::
::::
...
+ **Mid-Upper Arm Circumference**: it calculates z-scores of MUAC-for-Age, and then identifies outliers applying the same criterion of +/-3 z-scores of the survey mean. <br> 
 - Then outliers are excluded from the analysis
 - In the end, acute malnutrition is defined based on absolute [MUAC: < 125 mm]{.mark}
